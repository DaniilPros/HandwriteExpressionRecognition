...
namespace HWRE.UWP.Helpers
{
    ...
    {
        private static readonly Dictionary<string, string> Bcp47ToRecognizerNameDictionary =
        ...
        {
            if (!Bcp47ToRecognizerNameDictionary.TryGetValue(bcp47Tag, out string recognizerName))
